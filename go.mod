...
require (
	...
	kmodules.xyz/webhook-runtime v0.32.0 // indirect
	kubestash.dev/apimachinery v0.20.1-0.20250910102856-fb7f41c22675 // indirect
...
replace github.com/olekukonko/tablewriter => github.com/gomodules/tablewriter v0.0.6-0.20230422125635-f6b4e4ae60d8
