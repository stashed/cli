...
menu:
  product_stash_{{.version}}:
    identifier: kubectl-stash-cp-secret-{{ .subproject_version }}
    name: Cp Secret
...
---
## kubectl-stash cp secret

Copy Secret

### Synopsis

Copy Secret from one namespace to another namespace

```
kubectl-stash cp secret [flags]
```
